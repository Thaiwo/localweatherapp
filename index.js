$(document).ready(function() {
    ...
    if (navigator.geolocation) {
        ...
        navigator.geolocation.getCurrentPosition(function (position) {
            ...
            var url ='https://api.apixu.com/v1/current.json?key=98e062c84b49491d8f7135306192802&q=';
            $.getJSON(url + latitude + ', ' + longitude, function (data) {
                /* JSON.stringify turns a Javascript object into JSON text and turns that JSON text into a string */
